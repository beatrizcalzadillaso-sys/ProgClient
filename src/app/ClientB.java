...
public class ClientB {
			...
			while (opMenu != 5) {
				...
				switch (opMenu) {
					...
					case 3: {
						...
						if (!siCompro) {
							System.out.println("Debe comfirmar su seleccion antes de pasar a agregar productos");
							break;
						}
	...
	// listas de PRUEBA, CAMBIAR POR ArrayList para hacerlas dinamicas, para la hora
	// de integrar con admin
	...
	private static void resumenCompra() {
		...
		String[] etiquetas = new String[] { "10€", "5€", "2€", "1€", "0.50€", "0.20€", "0.10€", "0.05€", "0.02€",
				"0.01€" };
	...
	/*
	 * funcion que verifica que el id introducido este en el menu y la cantidad este
	 * en la norma
	 */
	private static boolean verificado(String idAdd, String cantidadAdd, List<ProductoItem> menuElegido) { // ERROR ESTA
																											// MIRANDO
																											// SOLAMENTE
